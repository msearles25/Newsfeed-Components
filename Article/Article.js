...
data.map(element => {
  const e = articlesDiv.append(createArticle(element.title, element.date, element.firstParagraph, element.secondParagraph, element.thirdParagraph))

  return e;
});

function createArticle(title, date, paraOne, paraTwo, paraThree) {
  ...
  contentOne.textContent = paraOne;
  contentTwo.textContent = paraTwo;
  contentThree.textContent = paraThree;
